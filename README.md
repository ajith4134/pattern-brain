...
- `dashboard/` — the §8 living-graph dashboard (FastAPI + React/ReactFlow/Plotly), incl. the step-3 Adapter-View tab.
- `tests/` — contract + behavior suites (`test_bank.py`, `test_connector.py`, `test_adapter.py`, `test_dashboard.py`).
