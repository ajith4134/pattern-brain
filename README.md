...
- `pattern_brain/` — the model bank + Connector Intelligence v0 (build steps 1-2) + routing v1 (`routing.py`, step 4).
...
- `dashboard/` — the §8 living-graph dashboard (FastAPI + React/ReactFlow/Plotly), incl. the step-3 Adapter-View tab and the step-4 routed-pathway card.
- `tests/` — contract + behavior suites (`test_bank.py`, `test_connector.py`, `test_adapter.py`, `test_routing.py`, `test_dashboard.py`).
